...
class TrapDialog(tk.Toplevel):
    def __init__(self, parent, riddle, options, correct_option, timeout=50):
        ...
        self.timer_label = tk.Label(
            ...
            font=self.get_standard_font(12, italic=True), 
            bg="#F5F5DC",
            fg="#333333"
        )
...
class EscapeRoomGameScreen(tk.Frame):
    ...
    def solve_puzzle(self):
        ...
        if player_answer and player_answer.strip().lower() == answer:
            ...
            self.run_prover9([f'solved({self.controller.player},{puzzle})'])  
...
class EscapeRoomApp(tk.Tk):
    def __init__(self):
        ...
        self.prover9_path = '/mnt/c/Users/Calina/Desktop/ANUL3/AI/Lab6 again/LADR-2009-11A/bin/prover9'
        self.current_state_file = 'current_state.in'
        self.actions = []  

        container = tk.Frame(self, bg="#D2B48C")  
